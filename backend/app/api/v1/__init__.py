...
from app.api.v1.recipe_video import (
    router as recipe_video_router,
)
...
from app.api.v1.weight_loss import (
    router as weight_loss_router,
)
...
api_router.include_router(recipe_video_router)
api_router.include_router(weight_loss_router)
